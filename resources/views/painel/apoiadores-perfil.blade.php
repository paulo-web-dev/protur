                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Apoiador</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5">
                            <div class="card text-center">
                                <div class="card-body">
                                    <img src="{{ asset('fotos-apoiadores/' . $apoiador->foto) }}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">

                                    <h4 class="mb-0 mt-2">{{$apoiador->nome}}</h4>
                                    <p class="text-muted font-14">apoiador</p>
                                    ...
                                    <div class="text-start mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Celular :</strong><span class="ms-2">{{$apoiador->celular}}</span></p>

                                        <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ms-2 ">{{$apoiador->email}}</span></p>

                                        <p class="text-muted mb-1 font-13"><strong>Cadastro :</strong> <span class="ms-2"><a href="{{$apoiador->site}}">{Clique aqui</a></span></p>
                                    </div>
...
{{-- 
                                         ...
                                         <div class="border border-light p-2 mb-3">
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="m-0">Protur</h5>
                                                        <p class="text-muted"><small>15 horas </small></p>
                                                    </div>
                                                </div>
                                                <p>Treinamento PROTUR - VENDA BLINDADA !!</p>

                                               <iframe src="https://www.youtube.com/embed/KK9V9L94vgs" height='300' class="img-fluid border-0"></iframe>
                                            </div>
                                           ...
                                           <div class="border border-light p-2 mb-3">
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="m-0">Protur</h5>
                                                        <p class="text-muted"><small>2 dias</small></p>
                                                    </div>
                                                </div>
                                                <p>Talk Blindado - Reembolsos Vencidos e Créditos Expirados</p>

                                              <iframe src="https://www.youtube.com/embed/CD12_a6cSOw" height='300' class="img-fluid border-0"></iframe>
                                            </div>
