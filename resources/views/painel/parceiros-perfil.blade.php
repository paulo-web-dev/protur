                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5">
                            <div class="card text-center">
                                <div class="card-body">
                                    <img src="{{ asset('fotos-parceiros/' . $parceiro->foto) }}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">

                                    <h4 class="mb-0 mt-2">{{$parceiro->nome}}</h4>
                                    <p class="text-muted font-14">Parceiro</p>
                                    ...
                                    <div class="text-start mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Celular :</strong><span class="ms-2">{{$parceiro->celular}}</span></p>
