...
@section('content')
  ...
  <form action="{{route('adm-upd-modulos', ['modulo' => $modulo->id])}}" enctype="multipart/form-data" data-single="true" method="post">
                ...
                <div class="intro-y box mt-5">
                    ...
                    <div class="p-5">
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                <div class="mt-3">
                                    ...
                                    <input id="update-profile-form-7" type="text" name="titulo" class="form-control"
                                        placeholder="Titulo do Modulo" value="{{$modulo->titulo}}">
                                </div>
                        ...
                        <div class="text-center">
                            <input type="submit" value="Atualizar Modulo" class="btn btn-primary mr-auto mb-2">
