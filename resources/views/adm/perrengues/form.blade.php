...
@section('content')
  ...
  <form action="{{route('adm-cad-perrengues')}}" enctype="multipart/form-data" data-single="true" method="post">
                ...
                <div class="intro-y box mt-5">
                    ...
                    <div class="p-5">
                        ...
                        <div class="text-center">
                            <input type="submit" value="Cadastrar Perrengue" class="btn btn-primary mr-auto mb-2">
