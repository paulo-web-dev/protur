...
@section('content')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">
        ...
        Lista de Categorias de Perrengues cadastradas
           </h2> 
        <a href="{{ route('home') }}" class="btn btn-primary shadow-md mr-2"><i data-feather="skip-back" class="w-4 h-4 mr-2"></i>Voltar</a>
        
     <a href="{{ route('adm-form-perrengues-cateroria') }}" data-theme="light" class="tooltip btn btn-primary"  title="Clique aqui para cadastrar categorias de perrengue"><i data-feather="plus" class="w-4 h-4 mr-2"></i> Adicionar Categoria de Perrengue</a>
            ...
            <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                ...
                <div class="box h-72">
                    ...
                    <div class="flex items-start px-5 pt-5">
                        ...
                        <a href="{{route('adm-info-perrengue-categoria', ['perrengueCategoria' => $perrengue->id])}}"
