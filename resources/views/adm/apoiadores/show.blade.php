...
@section('content')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">
     ...
     <a href="{{ route('adm-form-apoiador') }}" data-theme="light" class="tooltip btn btn-primary"  title="Clique aqui para cadastrar Apoiador"><i data-feather="plus" class="w-4 h-4 mr-2"></i> Adicionar Apoiador</a>
            ...
            <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                ...
                <div class="box h-72">
                    ...
                    <div class="flex items-start px-5 pt-5">
                        ...
                        <a href="{{route('adm-info-apoiador', ['apoiador' => $apoiador->id])}}"
                            ...
                            <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                                ...
                                <a href="{{route('adm-info-apoiador', ['apoiador' => $apoiador->id])}}"
                                    ...
                                    class="font-medium">{{ $apoiador->nome }}</a>

                                <div class="text-gray-600 text-xs mt-0.5">{{ $apoiador->email }}</div>
                            ...
                            <div class="dropdown-menu w-40">
                                ...
                                <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                    ...
                                    <a href="javascript:;" data-toggle="modal"
                                        ...
                                        data-target="#excluirProfessor{{ $apoiador->id }}"
                    ...
                    <div class="text-center lg:text-left p-5">
                        ...
                        <div class="flex items-center justify-center lg:justify-start text-gray-600 mt-5"> <i
                                ...
                                data-feather="mail" class="w-3 h-3 mr-2"></i> {{ $apoiador->cidade }} - {{$apoiador->uf}} </div>

                        <div class="flex items-center justify-center lg:justify-start text-gray-600 mt-1"> <i

                                data-feather="phone" class="w-3 h-3 mr-2"></i> {{ $apoiador->celular }} </div>
