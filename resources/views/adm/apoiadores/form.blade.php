 ...
 <div class="intro-y flex items-center mt-8">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 lg:col-span-12 xxl:col-span-12 tab-content">
            ...
            @endforeach
            <form action="{{route('adm-cad-apoiador')}}" method="post" enctype="multipart/form-data" data-single="true"
                method="post">
                @csrf
                        ...
                        <div class="grid grid-cols-12 gap-x-5">
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input id="Celular" type="text" name="celular" required class="form-control" placeholder="(XX) XXXXX-XXXX">
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input id="Sobre" type="text" name="sobre"  class="form-control"
                                        placeholder="Sobre o Parceiro" value="">
                                </div> 
                                <div class="mt-3">
                                    <label for="CNPJ" class="form-label"><strong>CNPJ</strong></label>
                                    <input id="CNPJ" type="text" name="cnpj" class="form-control" placeholder="CNPJ" value="">
                                </div>
