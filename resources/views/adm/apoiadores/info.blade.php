 ...
 <div class="intro-y flex items-center mt-8">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 lg:col-span-12 xxl:col-span-12 tab-content">
            ...
            @endforeach
            <form action="{{route('adm-upd-apoiador', ['apoiador' => $apoiador->id])}}" method="post" enctype="multipart/form-data" data-single="true"
                method="post">
                @csrf
                    ...
                    <div class="intro-y box col-span-12 xxl:col-span-12">
                        <div class="flex items-center p-5 border-b border-gray-200 dark:border-dark-5">
                            <h2 class="font-medium text-base mr-auto">
                             ...
                             <a href="{{ route('adm-show-apoiadores') }}" class="btn btn-primary shadow-md mr-2"><i data-feather="skip-back" class="w-4 h-4 mr-2"></i>Voltar</a>
                        </div>
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                <div class="mt-3">
                                    ...
                                    <input id="nome" type="text" name="nome" class="form-control"
                                        placeholder="Nome" value="{{$apoiador->nome}}" required>
                                </div>
                                <div class="mt-3">
                                    <label for="email" class="form-label"><strong>Email</strong></label>
                                    <input id="email" type="email" name="email" class="form-control"
                                      required  placeholder="Email" value="{{$apoiador->email}}" value="" >
                                </div>
                                <div class="mt-3">
                                    <label for="Celular" class="form-label"><strong>Celular</strong></label>
                                    <input id="Celular" type="text" name="celular" value="{{$apoiador->celular}}" required class="form-control" placeholder="(XX) XXXXX-XXXX">
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input id="Site" type="text" name="site"  class="form-control"
                                     value="{{$apoiador->site}}"   placeholder="Site">
                                </div>
                                 
                                <div class="mt-3">
                                    <label for="Sobre" class="form-label"><strong>Sobre</strong></label>
                                    <input id="Sobre" type="text" name="sobre"  class="form-control"
                                      value="{{$apoiador->sobre}}"  placeholder="Sobre o apoiador" value="">
                                </div>
                                  <div class="mt-3">
                                    <label for="CNPJ" class="form-label"><strong>CNPJ</strong></label>
                                    <input id="CNPJ" value="{{$apoiador->cnpj}}" type="text" name="cnpj" class="form-control" placeholder="CNPJ" value="">
                                </div>
                                 <br>
                            </div>
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="relative">
                                    <select class="form-control" name="uf" id="uf"
                                        ...
                                        <option value="{{$apoiador->uf}}">{{$apoiador->uf}}</option>
                                ...
                                <input id="cidade" type="text" name="cidade" class="form-control"
                                   value="{{$apoiador->cidade}}" placeholder="Cidade" required>
                                    </div>
