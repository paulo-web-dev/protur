...
@section('content')
  ...
  <form action="{{route('adm-cad-home')}}" enctype="multipart/form-data" data-single="true" method="post">
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                <div class="mt-3">
                                    ...
                                    <input id="update-profile-form-7" type="text" name="titulo_foto" class="form-control"
                                        placeholder="Título da imagem" value="">
                                </div>
                                 ...
                                 <div class="mt-3">
                                    ...
                                    <input id="update-profile-form-7" type="text" name="titulo_video" class="form-control"
                                        placeholder="Título do Vídeo" value="">
                                </div>
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input id="update-profile-form-7" type="text" name="video" class="form-control"
                                        placeholder="Link do Vídeo" value="">
                                </div>
                                    </div>
                                </div>
                            </div><br>
                        <div class="text-center">
                            <input type="submit" value="Cadastrar Home" class="btn btn-primary mr-auto mb-2">
