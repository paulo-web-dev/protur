 ...
 <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            ...
            <a href="{{ route('adm-form-home') }} " class="text-right btn btn-primary w-49 mr-5 mt-2 mb-2 "> <i
                    data-feather="plus" class="w-4 h-4 mr-2"></i> Adicionar Home
            </a>
        ...
        @foreach ($homes as $home)
            <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                <div class="file box rounded-md px-5 pt-8 pb-5 sm:px-5 relative zoom-in">
                        ...
                        <a href="{{ route('adm-info-home', ['home' => $home->id]) }}">
                            <img alt="" class="rounded-md"
                                src="{{ url("fotos-home/$home->foto") }}">
                        </a>
                
                    

                    <div class="text-gray-900 text-sm text-left mt-0.5">
                        <a href="{{ route('adm-info-home', ['home' => $home->id]) }}" target="_blank">
                            {{ $home->titulo_foto }}
                        </a> <br>
