 ...
 <!-- END: Top Bar -->
                ...
                <div class="absolute mb-1 mr-1 flex items-center justify-center bottom-0 right-0 bg-primary rounded-full p-2"> <i class="w-4 h-4 text-white" data-feather="camera"></i> </div>
                        ...
                        <div class="mt-6 lg:mt-0 flex-1 px-5 border-t lg:border-0 border-slate-200/60 dark:border-darkmode-400 pt-5 lg:pt-0">
                            ...
                            <div class="truncate sm:whitespace-normal flex items-center">Instituição: </div> 
                            <div class="truncate sm:whitespace-normal flex items-center">Sua Assinatura Vence em:</div>
                            <div class="truncate sm:whitespace-normal flex items-center">Número de Colaboradores: </div>
                        </div>
                ...
                <div class="box h-72">
                    ...
                    <div class="text-center lg:text-left p-5">
                        ...
                        <div class="flex items-center justify-center lg:justify-start text-gray-600 mt-5"> <i
                                ...
                                data-feather="mail" class="w-3 h-3 mr-2"></i>  </div>

                        <div class="flex items-center justify-center lg:justify-start text-gray-600 mt-1"> <i

                                data-feather="phone" class="w-3 h-3 mr-2"></i></div>
