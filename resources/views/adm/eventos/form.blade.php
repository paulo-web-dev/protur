...
@section('content')
  ...
  <form action="{{route('adm-cad-evento')}}" enctype="multipart/form-data" data-single="true" method="post">
                ...
                <div class="intro-y box mt-5">
                    ...
                    <div class="p-5">
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                <div class="mt-3">
                                    ...
                                    <input id="update-profile-form-7" type="text" name="titulo" class="form-control"
                                        placeholder="Título do evento" value="">
                                </div>
                                <div class="mt-3">
                                    ...
                                    <div class="relative mx-auto">
                                        ...
                                        <input type="date" autocomplete="off" class="data form-control pl-12"
                                            name="data" value="" data-single-mode="true">
                                    </div>
                                </div>
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                 <div class="mt-3">
                                    ...
                                    <input id="update-profile-form-7" type="time" name="horario"
                                        class="form-control" placeholder="Horário" >
                                </div>
                        ...
                        <div class="text-center">
                            <input type="submit" value="Cadastrar Evento" class="btn btn-primary mr-auto mb-2">
