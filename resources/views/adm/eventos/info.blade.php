...
@section('content')
  ...
  <form action="{{route('adm-upd-evento', ['evento' => $evento->id])}}" enctype="multipart/form-data" data-single="true" method="post">
                ...
                <div class="intro-y box mt-5">
                    ...
                    <div class="p-5">
                        ...
                        <div class="grid grid-cols-12 gap-x-5">
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                <div class="mt-3">
                                    ...
                                    <input id="update-profile-form-7" type="text" name="titulo" class="form-control"
                                        placeholder="Título do evento" value="{{$evento->titulo}}">
                                </div>
                                <div class="mt-3">
                                    ...
                                    <div class="relative mx-auto">
                                        ...
                                        <input type="date" autocomplete="off" class="data form-control pl-12"
                                            name="data" value="{{$evento->data}}" data-single-mode="true">
                                    </div>
                                </div>
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                 <div class="mt-3">
                                    <label for="update-profile-form-7" class="form-label"><strong>Horário
                                            </strong></label>
                                    <input id="update-profile-form-7" type="time" name="horario"
                                        class="form-control" value="{{$evento->horario}}" placeholder="Horário" >
                                </div>
                        ...
                        <div class="text-center">
                            <input type="submit" value="Atualizar Evento" class="btn btn-primary mr-auto mb-2">
