        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              <h3 class="fs-2 fs-md-3">A criança ou o adolescente vai viajar de volta ao país onde reside?</h3>
              <p>A comprovação da residência da criança ou adolescente no exterior é feita por Atestado de Residência emitido por repartição consular brasileira há menos de dois anos (art. 2º, §1º da Resolução CNJ nº 131/2011)
                ...
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="news/news.html">
                        <h5 data-zanim-xs='{"delay":0}'>SIM:</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-viajavolta')}}"><button class="btn btn-warning w-100" >Iniciar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
                ...
                <div class="card"><a href="#"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="#">
                        <h5 data-zanim-xs='{"delay":0}'>NÃO</h5>
                      </a></div>
                   
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-sozinho-acompanhado-exterior')}}"><button class="btn btn-warning w-100" >Iniciar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
