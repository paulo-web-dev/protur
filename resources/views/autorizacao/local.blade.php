        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              <h3 class="fs-2 fs-md-3">A viagem é para o exterior ou nacional?</h3>
              ...
              <div class="col-md-6 col-lg-6">
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    ...
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-residencia')}}"><button class="btn btn-warning w-100">Iniciar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
                ...
                <div class="card"><a href="#"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="#">
                        <h5 data-zanim-xs='{"delay":0}'>Nacional</h5>
                      </a></div>
                   
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-nacional')}}"><button class="btn btn-warning w-100">Iniciar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
