        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              <h3 class="fs-2 fs-md-3">Não é necessária a autorização de viagem ao exterior.</h3>
              <p>Se a criança ou adolescente for residente no exterior, estiver viajando de volta ao país onde reside, acompanhado(a) de pelo menos um dos genitores (pai ou mãe), não é necessária a autorização de viagem ao exterior (art. 2º, I, da Resolução CNJ nº 131/2011).
              </p>
              <p>A comprovação da residência da criança ou do adolescente no exterior é feita por Atestado de Residência emitido por repartição consular brasileira há menos de dois anos (art. 2º, §1º da Resolução CNJ nº 131/2011)
              </p>
              <p>A criança ou adolescente deve portar passaporte válido para o embarque ao exterior.</p>
              <p>Para alguns países da América do Sul, é permitido o embarque também com carteira de identidade com menos de 10 anos de emissão (consulte companhia aérea ou empresa de turismo).</p>
            ...
            <center>
              <div class="col-md-6 col-lg-6">
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="news/news.html">
                        <h5 data-zanim-xs='{"delay":0}'>Voltar Ao Início:</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-home')}}"><button class="btn btn-warning w-100" type="submit">Início</button></a></div>
                    </div>
                    <div class="overflow-hidden">
