        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              <h3 class="fs-2 fs-md-3">O destino da viagem é comarca vizinha à da residência da criança ou do adolescente, dentro do mesmo Estado; ou incluída na mesma região metropolitana?</h3>
              <p>Obs.: Se não tiver certeza da resposta, clique em não sei.
            ...
            <div class="row g-4">
              <div class="col-md-6 col-lg-4">
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    ...
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-nacional-comarca')}}"><button class="btn btn-warning w-100">Iniciar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="news/news.html">
                        <h5 data-zanim-xs='{"delay":0}'>NÃO SEI:</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><button class="btn btn-warning w-100">Iniciar</button></div>
                    </div>
                    <div class="overflow-hidden">
