        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              ...
              <p>Se a criança ou o adolescente estiver acompanhado(a) de mãe E pai, ou de guardião(ã) ou ainda de tutor(a), não é necessária a autorização de viagem ao exterior (art. 84 da Lei Federal 8069/1990 – Estatuto da Criança e do Adolescente).
              </p>
              <b>Documentos básicos para embarque da criança ou adolescente:
              </b>
              <p>passaporte válido para o embarque ao exterior;</p>
              ...
              <p>Dependendo do país de destino, é necessário que a criança ou o adolescente tenha visto de entrada no país (consulte companhia aérea ou empresa de turismo).</p>
              ...
              <div class="col-md-6 col-lg-6">
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    ...
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><button class="btn btn-warning w-100" type="submit">Início</button></div>
                    </div>
                    <div class="overflow-hidden">
