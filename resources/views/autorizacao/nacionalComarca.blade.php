        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              ...
              <p>Não há necessidade de autorização de viagem se o destino for:
              </p>
              <p>a) comarca vizinha dentro do mesmo Estado; ou
              </p>
              <p>b) comarca dentro da mesma região metropolitana.
              </p>
              <p><b>Fundamento:</b> art. 83, §1º, ‘a’ do Estatuto da Criança e do Adolescente (Lei 8069/1990)
              </p>
