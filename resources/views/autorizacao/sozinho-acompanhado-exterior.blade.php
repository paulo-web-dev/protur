        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              <h3 class="fs-2 fs-md-3">Vai viajar sozinho ou acompanhado?</h3>
              <p>Autorização de Viagem de Criança e Adolescente
            ...
            <div class="row g-4">
              <div class="col-md-6 col-lg-6">
                <div class="card"><a href="{{route('autorizacao-sozinho')}}"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="{{route('autorizacao-sozinho')}}">
                        <h5 data-zanim-xs='{"delay":0}'>SOZINHO</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-sozinho')}}"><button class="btn btn-warning w-100" >Avançar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
                ...
                <div class="card"><a href="#"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="#">
                        <h5 data-zanim-xs='{"delay":0}'>ACOMPANHADO</h5>
                      </a></div>
                   
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-acompanhado')}}"><button class="btn btn-warning w-100" >Avançar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
