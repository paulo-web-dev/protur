        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              <h3 class="fs-2 fs-md-3">Quem é o(a) acompanhante?</h3>
            ...
            <d class="row g-4">
                ...
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="news/news.html">
                        <h5 data-zanim-xs='{"delay":0}'>Pai ou Mãe:</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-acompanhadopai')}}"><button class="btn btn-warning w-100" >Avançar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="news/news.html">
                        <h5 data-zanim-xs='{"delay":0}'>Avô ou Avó:</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('')}}"><button class="btn btn-warning w-100" >Avançar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card"><a href="#"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="#">
                        <h5 data-zanim-xs='{"delay":0}'>Irmão(a) ou Tio(a):</h5>
                      </a></div>
                ...
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="news/news.html">
                        <h5 data-zanim-xs='{"delay":0}'>Gardioão ou Tutor:</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="news/news.html">
                        <h5 data-zanim-xs='{"delay":0}'>Outra Pessoa Maior de 18 anos:</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><button class="btn btn-warning w-100" type="submit">Avançar</button></div>
                    </div>
                    <div class="overflow-hidden">
