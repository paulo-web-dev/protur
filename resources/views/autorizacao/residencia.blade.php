        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              <h3 class="fs-2 fs-md-3">Onde reside a criança ou o adolescente que vai viajar??</h3>
                ...
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="news/news.html">
                        <h5 data-zanim-xs='{"delay":0}'>Brasil:</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-sozinho-acompanhado-exterior')}}"><button class="btn btn-warning w-100" >Avançar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
                ...
                <div class="card"><a href="#"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="#">
                        <h5 data-zanim-xs='{"delay":0}'>Exterior</h5>
                      </a></div>
                   
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-exterior')}}"><button class="btn btn-warning w-100" >Avançar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
