        ...
        <section class="bg-100" id="iniciar">
          <div class="container">
            <div class="text-center mb-6">
              <h3 class="fs-2 fs-md-3">A criança ou o adolescente tem passaporte com autorização para viajar ao exterior desacompanhado(a)?</h3>
              ...
              <div class="col-md-6 col-lg-6">
                <div class="card"><a href="news/news.html"></a>
                  <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                    <div class="overflow-hidden"><a href="{{route('autorizacao-sozinho-pass')}}">
                        <h5 data-zanim-xs='{"delay":0}'>SIM</h5>
                      </a></div>
                    <div class="overflow-hidden">
                    </div>
                    <div class="overflow-hidden">
                      <div class="col-6 mt-4"><a href="{{route('autorizacao-sozinho-pass')}}"><button class="btn btn-warning w-100" >Avançar</button></a></div>
                    </div>
                    <div class="overflow-hidden">
