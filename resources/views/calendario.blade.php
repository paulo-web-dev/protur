            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarDashboards">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="dashboard-analytics.html">Parceiro 01</a>
                                </li>
                                <li>
                                    <a href="index.html">Parceiro 02</a>
                                </li>
                                <li>
                                    <a href="dashboard-projects.html">Parceiro 03</a>
                                </li>
                                <li>
                                    <a href="dashboard-crm.html">Parceiro 04</a>
                                </li>
                                <li>
                                    <a href="dashboard-wallet.html">Parceiro 05</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        <a href="apps-chat.html" class="side-nav-link">
                            <i class="uil-comments-alt"></i>
                            <span>Suporte  agente de viagens </span>
                        </a>
                    </li>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="d-grid">
                                                <button class="btn btn-lg font-16 btn-danger" id="btn-new-event">
                                                    <i class="mdi mdi-plus-circle-outline"></i> Adicionar Evento
                                                </button>
                                            </div>
                                            <div id="external-events" class="mt-3">
                                                <p class="text-muted">Arraste para a data o evento ou crie um novo.</p>
                                                <div class="external-event bg-success-lighten text-success" data-class="bg-success"><i class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Live Agendada</div>
                                                <div class="external-event bg-info-lighten text-info" data-class="bg-info"><i class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Reunião de diretoria</div>
                                                <div class="external-event bg-warning-lighten text-warning" data-class="bg-warning"><i class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Atividade com urgência</div>
                                                <div class="external-event bg-danger-lighten text-danger" data-class="bg-danger"><i class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Reunião de emergência</div>
                                            </div>
                                        ...
                                        <form class="needs-validation" name="event-form" id="form-event" novalidate>
                                            ...
                                            <div class="modal-body px-4 pb-4 pt-0">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <label class="control-label form-label">Evento </label>
                                                            <input class="form-control" placeholder="Insira o nome do evento" type="text" name="title" id="event-title" required />
                                                            <div class="invalid-feedback">Por favor insira um valor válido</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <label class="control-label form-label">Cor</label>
                                                            <select class="form-select" name="category" id="event-category" required>
                                                                <option value="bg-danger" selected>Vermelho</option>
                                                                <option value="bg-success">Verde</option>
                                                                <option value="bg-primary">Roxo</option>
                                                                <option value="bg-info">Azul</option>
                                                                <option value="bg-dark">Preto</option>
                                                                <option value="bg-warning">Amarelho</option>
                                                            </select>
                                                            <div class="invalid-feedback">Insira uma categoria válida</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
...
<!-- Mirrored from coderthemes.com/hyper_2/saas/apps-calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 May 2024 15:58:53 GMT -->
</html>